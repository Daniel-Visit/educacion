        ...
        contenido: JSON.stringify({
          ...
          content: [
            ...
            },
            {
              type: "paragraph",
              content: [
                { type: "text", text: "Esta planificación cubre los fundamentos del álgebra para estudiantes de primer año." }
              ]
            },
            {
              type: "image",
              ...
              content: [
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "Comprender las operaciones básicas con variables" }]
                    }
                  ]
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "Resolver ecuaciones lineales simples" }]
                    }
                  ]
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "Aplicar conceptos algebraicos en problemas reales" }]
                    }
                  ]
                }
              ]
        ...
        contenido: JSON.stringify({
          ...
          content: [
            ...
            },
            {
              type: "paragraph",
              content: [
                { type: "text", text: "Una ecuación lineal es una igualdad que contiene una o más variables elevadas a la primera potencia." }
              ]
            },
            {
              type: "image",
            ...
            },
            {
              type: "paragraph",
              content: [
                { type: "text", text: "2x + 3 = 7" }
              ]
            },
            {
              type: "paragraph",
              content: [
                { type: "text", text: "Para resolver esta ecuación:" }
              ]
            },
            {
              type: "orderedList",
              content: [
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "Restar 3 a ambos lados: 2x = 4" }]
                    }
                  ]
                },
                {
