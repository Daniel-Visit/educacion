            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-2xl font-bold">
                  {Math.round((totalPreguntasIndicadores / matriz.total_preguntas) * 100)}%
                </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="bg-gradient-to-br from-indigo-500 to-purple-500 text-white px-3 py-1 rounded-full text-sm font-bold">
                ...
                {matrizOA.indicadores.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {matrizOA.indicadores.map((indicador, idx) => (
                      <div key={indicador.id} className="group/indicator bg-gradient-to-r from-gray-50 to-gray-100 hover:from-indigo-50 hover:to-purple-50 border border-gray-200 hover:border-indigo-200 rounded-xl p-4 transition-all duration-200">
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
