...
import { Upload, FileText, Users, BarChart3, CheckCircle2, TrendingUp } from 'lucide-react';
      ...
      <div className="container mx-auto p-6">
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-indigo-600 font-medium">Cargando evaluaciones...</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="bg-white/10 rounded-lg p-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-lg font-bold">
                  {evaluaciones.length > 0 ? Math.round(evaluaciones.reduce((sum, e) => sum + e.preguntasCount, 0) / evaluaciones.length) : 0}
                </p>
              </div>
            </div>
          </div>
