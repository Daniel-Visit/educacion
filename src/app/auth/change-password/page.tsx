...
export default function ChangePasswordPage() {
  ...
  const passwordRequirements = {
    ...
    hasMatch: formData.newPassword === formData.confirmPassword && formData.confirmPassword.length > 0
  };
    ...
    try {
      ...
      if (error instanceof z.ZodError) {
        ...
        (error as any).errors.forEach((err: any) => {
          const field = err.path[0] as keyof ChangePasswordForm;
          ...
          <CardContent className="p-6">
            ...
            {success && (
              <div className="mb-4 p-3 bg-green-100 text-green-600 rounded-lg border border-green-200">
                ...
                <p className="text-xs mt-1">Serás redirigido al login en unos segundos...</p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-xs font-medium text-blue-700 mb-2">Requerimientos de seguridad:</p>
