  ...
  const sections = [
    {
      ...
      description:
        'Gestiona la planificación anual de clases con calendario interactivo y asignación de objetivos de aprendizaje',
      icon: Calendar,
    ...
    },
    {
      ...
      description:
        'Crea planificaciones de clase y materiales de apoyo con un editor avanzado y herramientas de IA',
      icon: Edit3,
    ...
    },
    {
      title: 'Evaluaciones',
      description:
        'Crea y gestiona evaluaciones basadas en matrices de especificación con preguntas inteligentes',
      icon: CheckSquare,
    ...
    },
    {
      ...
      description:
        'Revisa los resultados de las evaluaciones de tus estudiantes y analiza el desempeño de cada uno',
      icon: FileText,
            ...
            >
              ...
              <div className="relative z-10 flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div
                    className={`inline-flex items-center justify-center w-10 h-10 bg-gradient-to-br ${section.gradient} rounded-xl shadow-lg mb-3 group-hover:scale-110 transition-transform duration-300`}
                  >
                ...
                <ArrowRight
                  className={`w-5 h-5 text-gray-400 group-hover:text-gray-600 group-hover:translate-x-1 transition-all duration-300 ${section.isPrimary ? 'text-emerald-500' : ''}`}
                />
              </div>
              ...
              <div className="relative z-10">
                <div className="flex flex-wrap gap-1.5 mb-4">
                  {section.features.map((feature, featureIndex) => (
                    <span
                      key={featureIndex}
                      className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-white/70 backdrop-blur-sm text-gray-700 border border-white/50"
                    >
                      {feature}
                    </span>
                  ))}
                ...
                {/* CTA Button */}
                <div
                  className={`inline-flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r ${section.gradient} text-white rounded-lg font-medium text-xs shadow-lg group-hover:shadow-xl transition-all duration-300`}
                >
                  {section.isPrimary ? (
                    <>
                      <Sparkles size={12} />
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
        <div className="bg-white/50 backdrop-blur-sm border border-gray-200 rounded-xl p-4 text-center">
          ...
          <p className="text-gray-600 text-xs">
            Asistencia inteligente para tu práctica docente
          </p>
        </div>
        ...
        <div className="bg-white/50 backdrop-blur-sm border border-gray-200 rounded-xl p-4 text-center">
          ...
          <p className="text-gray-600 text-xs">
            Información actualizados del contexto territorial{' '}
          </p>
        </div>
        <div className="bg-white/50 backdrop-blur-sm border border-gray-200 rounded-xl p-4 text-center">
          ...
          <p className="text-gray-600 text-xs">
            Información histórica del colegio
          </p>
        </div>
      </div>
    </>
