...
export default function UsersManagement() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Alertas inline - Posicionadas arriba de la tabla para mejor visibilidad */}
      {alert && (
        <div
          className={`rounded-md p-3 mb-4 ${
            alert.type === 'error'
              ? 'bg-red-50 dark:bg-red-500/15 dark:outline dark:outline-red-500/25 border border-red-200'
              : 'bg-green-50 dark:bg-green-500/10 dark:outline dark:outline-green-500/20 border border-green-200'
          }`}
        >
                ...
                <button
                  ...
                  className={`inline-flex rounded-md p-1.5 hover:bg-opacity-80 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden ${
                    alert.type === 'error'
                      ...
                      : 'bg-green-50 text-green-500 hover:bg-green-100 focus-visible:ring-green-600 focus-visible:ring-offset-green-50 dark:bg-transparent dark:text-green-400 dark:hover:bg-green-500/10 dark:focus-visible:ring-green-500 dark:focus-visible:ring-offset-1 dark:focus-visible:ring-offset-red-900'
                  }`}
                >
