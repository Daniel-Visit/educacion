...
import {
  ...
  PopoverContent,
  PopoverTrigger,
} from "@/components/ui-calendar/popover"
import {
  DraggableEvent,
  DroppableCell,
  EventGap,
            ...
            {week.map((day, dayIndex) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="group-data-today:bg-gradient-to-r from-indigo-600 to-purple-500 group-data-today:text-primary-foreground mt-1 inline-flex size-6 items-center justify-center rounded-full text-sm">
                      {format(day, "d", { locale: es })}
                    </div>
                    <div
                      ref={isReferenceCell ? contentRef : null}
                      className="min-h-[calc((var(--event-height)+var(--event-gap))*2)] sm:min-h-[calc((var(--event-height)+var(--event-gap))*3)] lg:min-h-[calc((var(--event-height)+var(--event-gap))*2)]"
                    >
