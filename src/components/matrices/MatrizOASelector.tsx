      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            <Listbox value={selectedEjeContenido} onChange={onEjeContenidoChange}>
          ...
          <div className="flex-1">
            <Listbox value={selectedOAsContenido} onChange={onOAsContenidoChange} multiple>
              <div className="relative mt-1">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {selectedOAsContenido.map(oa => (
                      <span key={oa.id} className="flex items-center bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm">
                        ...
                        <button
                          type="button"
                          onClick={() => onOAsContenidoChange(selectedOAsContenido.filter(o => o.id !== oa.id))}
        ...
        {ejesHabilidad.length > 0 && (
          <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            <Listbox value={selectedEjeHabilidad} onChange={onEjeHabilidadChange}>
              <div className="relative mt-1">
          ...
          <div className="flex-1">
            <Listbox value={selectedOAsHabilidad} onChange={onOAsHabilidadChange} multiple>
              <div className="relative mt-1">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {selectedOAsHabilidad.map(oa => (
                      <span key={oa.id} className="flex items-center bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm">
                        ...
                        <button
                          type="button"
                          onClick={() => onOAsHabilidadChange(selectedOAsHabilidad.filter(o => o.id !== oa.id))}
