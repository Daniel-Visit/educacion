...
export default function FabPlanificaciones({ onLoadContent, tipoActual }: FabPlanificacionesProps) {
  const [open, setOpen] = useState(false);
  const { savedContents, isLoading } = useContentSave();

  // Filtrar archivos por el tipo actual
  const filteredContents = savedContents.filter(content => content.tipo === tipoActual);
