    ...
    <div className="flex flex-col items-center justify-center w-full h-full min-h-[400px]">
      <div className="flex flex-col items-center w-full max-w-xl bg-white rounded-3xl shadow-2xl p-8 border border-indigo-100">
        <div className="mb-6 flex flex-col items-center">
          <CheckCircle2 className="text-indigo-500 animate-pulse mb-2" size={48} />
          <h2 className="text-2xl font-bold text-indigo-800 mb-2 text-center">Resumen de tus respuestas</h2>
          <p className="mb-4 text-gray-600 text-center">Hola Francisca, aquí tienes un resumen de la información que me has proporcionado:</p>
        </div>
