          ...
          content: [
            {
              type: 'heading',
              attrs: { level: 1 },
              content: [{ type: 'text', text: 'Planificación de Clase: Suma y Resta' }]
            },
            {
              type: 'paragraph',
              content: [
                { type: 'text', text: 'Esta es una planificación de ejemplo para una clase de matemáticas de 1° básico.' }
              ]
            },
            {
              type: 'heading',
              ...
              content: [
                {
                  ...
                  content: [
                    {
                      type: 'paragraph',
                      content: [{ type: 'text', text: 'Comprender la suma y resta de números hasta 20' }]
                    }
                  ]
                },
                {
                  ...
                  content: [
                    {
                      type: 'paragraph',
                      content: [{ type: 'text', text: 'Resolver problemas matemáticos simples' }]
                    }
                  ]
                }
              ]
          ...
          content: [
            {
              type: 'heading',
              attrs: { level: 1 },
              content: [{ type: 'text', text: 'Material de Apoyo: El Sistema Solar' }]
            },
            {
              type: 'paragraph',
              content: [
                { type: 'text', text: 'Este material de apoyo ayuda a los estudiantes a comprender el sistema solar.' }
              ]
            },
            {
              type: 'heading',
              ...
              content: [
                {
                  ...
                  content: [
                    {
                      type: 'paragraph',
                      content: [{ type: 'text', text: 'Mercurio - El planeta más cercano al Sol' }]
                    }
                  ]
                },
                {
                  ...
                  content: [
                    {
                      type: 'paragraph',
                      content: [{ type: 'text', text: 'Venus - El planeta más caliente' }]
                    }
                  ]
                },
                {
                  ...
                  content: [
                    {
                      type: 'paragraph',
                      content: [{ type: 'text', text: 'Tierra - Nuestro hogar' }]
                    }
                  ]
                }
              ]
